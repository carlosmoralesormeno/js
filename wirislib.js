...
js.src = "./plugins/tinymce5/plugins/tiny_mce_wiris/integration/WIRISplugins.js?viewer=image";
...
function createEditorInstance(lang, wiriseditorparameters) {
	...
	let tinyMCEConfiguration = {
		mode : "specific_textareas", editor_selector : "mceEditor", theme: "silver", menubar: false,
		language: "es",
		plugins: 'print preview paste importcss searchreplace autolink autosave save directionality code visualblocks visualchars fullscreen image link media template codesample table charmap hr pagebreak nonbreaking anchor toc insertdatetime advlist lists wordcount textpattern noneditable help charmap quickbars emoticons tiny_mce_wiris ',
		video_template_callback: function(data) {
			return '<video class="embed-responsive embed-responsive-16by9" width="' + data.width + '" height="' + data.height + '"' + (data.poster ? ' poster="' + data.poster + '"' : '') + ' controls="controls">\n' + '<source src="' + data.source + '"' + (data.sourcemime ? ' type="' + data.sourcemime + '"' : '') + ' />\n' + '</video>';
		  },
		image_class_list: [
			{ title: 'Bordes', value: 'img-fluid rounded' },
			{ title: 'Sin Bordes', value: 'img-fluid' },
			{ title: 'Circular', value: 'img-fluid rounded-circle' }
		],
		toolbar1: "undo redo | bold italic underline strikethrough |  alignleft aligncenter alignright alignjustify | image | table | subscript superscript | charmap emoticons media ltr rtl fullscreen | cut copy paste pastetext | tiny_mce_wiris_formulaEditor tiny_mce_wiris_formulaEditorChemistry | youtube |",
		image_advtab: true,
		height: "200",
		forced_root_block: "",
		branding: false,
		...
		external_plugins: { "filemanager": "/saie/plugins/filemanager/plugin.min.js", "youtube": "/saie/plugins/tinymce5/plugins/youtube/plugin.min.js", },
